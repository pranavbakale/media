    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black relative">
          ...
          <div className="max-w-7xl mx-auto relative mb-24 z-10">
            <motion.div className="flex justify-center mb-12">
              <h2 className="text-3xl md:text-4xl mt-24 font-bold text-center relative inline-block">
        ...
        <section className="pt-0 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-800 via-orange-700 to-yellow-600 text-white">
          <div className="max-w-7xl mx-auto mb-16 text-center">
            <motion.div className="flex justify-center mb-12">
              <h2 className="text-3xl mt-24 md:text-4xl font-bold relative inline-block">
